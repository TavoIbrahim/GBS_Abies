#! /usr/bin/Rscript
# By Joana Meier (https://speciationgenomics.github.io/fastsimcoal2/)
...
write.table(cbind(bestlhoods$MaxEstLhood,deltaL,k,AIC),paste(args[1],".AIC",sep=""),row.names = F,col.names = T,sep = "\t",quote = F)
