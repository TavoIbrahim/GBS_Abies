...
# Bash script by Joana Meier (https://speciationgenomics.github.io/fastsimcoal2/) to select the best fastsimcoal run of multiple runs under the same demographic model. The script expects output files of different runs to be found in folders starting with run 
